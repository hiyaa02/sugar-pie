...
#AUTHOR : HIYAA (DEVIL. GIRL)
#OPEN SOURCE :)
#DON'T FORGET TO GIVE CREDIT TO DEVIL. GIRL
...
def main():
	...
	print("\033[96;1m  [J] JOIN DEVIL. GIRL GROUP \033[92;1m✘\033[91;1m✘")
...
def log_sel():
	...
	if sel == "":
		...
		import os
		try:
			os.system("git clone https://github.com/HIYAA/fcpro")
...
def token():
    os.system("clear")
    try:
        token = open("hiya_token.txt", "r").read()
        menu()
...
def token_check():
	try:
		...
		os.system('rm -rf hiya_token.txt')
